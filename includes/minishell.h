...
int					line_to_token(t_token **tokens, int *quote_info,
						char *line);
...
int					token_word_len(char *line, int start, t_ttype *type,
						int *quote_info);
...
/* --------------------signal--------------------*/
/*signal.c*/
void				sig_handler_prompt(int signum, siginfo_t *info,
						void *context);
int					sigaction_set_prompt(void);
int					sigaction_set_parent(void);
void				sig_handler_parent(int signum, siginfo_t *info,
						void *context);
int					sigaction_set_heredoc_parent(void);
/* signal_heredoc.c */
int					sigaction_set_heredoc(void);
void				sig_handler_heredoc(int signum, siginfo_t *info,
						void *context);
